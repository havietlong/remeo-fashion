<template>
      ...
      <div class="productsTab">
       <h1>
        ...
        <table>
          ...
          <tbody v-for="product in products" :key="product.date">
            <tr @click="loadDataOrder_items(product.date)">
              <td>{{ product.date }}</td>
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr v-for="product in Order_items" :key="product.id">
                        <td><img style="width: 100px;" :src="product.image_link"></td>
                        <td>{{ product.name }}</td>
  ...
  export default {
    ...
    methods: {
      ...
      loadDataOrder_items(order_date) {
